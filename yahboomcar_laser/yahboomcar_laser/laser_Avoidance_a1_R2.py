# laser_Avoidance_a1_R2.py
# ==========================
# Desvio de obstáculos com RPLIDAR A1 para o robô R2 (Ackermann).
# Código praticamente idêntico ao laser_Avoidance_a1_X3.py.
# A diferença está no node name ("laser_Avoidance_a1" — igual ao X3).
#
# CONVENÇÃO DE ÂNGULOS — RPLIDAR A1 (montado para trás, yaw=π):
#   "Frente" do robô = abs(angle) > 160°
#   Mesmos setores que a1_X3.
#
# Para R2 (Ackermann): os comandos de velocidade Y são ignorados pelo driver,
# apenas linear.x e angular.z são efetivos. O comportamento de desvio é o mesmo.
