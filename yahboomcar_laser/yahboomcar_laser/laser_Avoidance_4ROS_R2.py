# laser_Avoidance_4ROS_R2.py
# ===========================
# Desvio de obstáculos com YDLIDAR X4 (4ROS) para o robô R2 (Ackermann).
# Código praticamente idêntico ao laser_Avoidance_4ROS.py (X3).
#
# CONVENÇÃO DE ÂNGULOS — YDLIDAR X4 (montado de frente):
#   "Frente" do robô = abs(angle) < 10°
#   Mesmos setores que 4ROS X3.
#
# Para R2 (Ackermann): só linear.x e angular.z efetivos (sem lateral).
