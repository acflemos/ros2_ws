# laser_Avoidance_4ROS.py
# ========================
# Desvio de obstáculos com YDLIDAR X4 (4ROS) para o robô X3 (mecanum).
#
# CONVENÇÃO DE ÂNGULOS — YDLIDAR X4 no X3:
#   O LiDAR está montado de frente no X3, logo:
#   "Frente" do robô = frente do LiDAR = abs(angle) < 10°
#   "Esquerda" = setor 10° a (10+LaserAngle)°
#   "Direita" = setor -10° a -(10+LaserAngle)°
#   (Oposto ao a1 que usa abs(angle) > 160° para a frente)
#
# Lógica: 10 casos idênticos ao laser_Avoidance_a1_X3.py mas com setores diferentes.
# ResponseDist padrão: 0.55m (zona de perigo = 1.5× = 0.825m)
#
# Nota: este ficheiro não está registado em setup.py (entry_points) —
# não pode ser lançado como `ros2 run`. Apenas laser_Avoidance_a1_X3 está registado.
#
