# laser_Tracker_a1_R2.py
# =======================
# Seguidor de obstáculos com RPLIDAR A1 para o robô R2 (Ackermann).
# Código idêntico ao laser_Tracker_a1_X3.py (mesma convenção de ângulos a1).
# Node name: "laser_Tracker_a1" (mesmo do X3 — colisão se ambos executados).
#
# Para R2: linear.x e angular.z efetivos (sem lateral y).
# A1 convenção (montado para trás): frente = abs(angle) > (180-priorityAngle)°.
